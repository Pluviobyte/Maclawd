...
本轮根据评审反馈，把质量基线从“每个动作都有完整小场景”修正为“身体先演，道具只做必要提示”。除 **Top-down Sleep** 外，其余 22 个动作不再使用完整横向底座。

V5.3 不再只压缩宽度，而是删除构成横线的物品：地毯、低桌、路径、餐垫、软垫、地面条、晾衣绳和横向木杆。96px 渲染下，23 个当前动作的最大横向包围盒为 `16–48px`；睡眠床铺与少数单侧道具达到 48px，但不形成横向舞台。
