...
2. 禁止地毯、桌面、路径、地台、软垫、横杆、床垫和任何完整底座；`sleeping` 也只保留贴身枕头、毛毯与 Zzz。
...
| `sleeping` | Top-down Sleep | 6.4s | 贴身枕头、同一条毛毯与像素 Zzz，无床垫 | 整只俯视平躺盖被，闭眼和双爪露出 |
...
- `away → sleeping → waking → idle` 共享紫色毛毯；睡眠段不再出现完整床铺，只保留俯视平躺、贴身枕头、盖被与明确的 `Zzz`。
