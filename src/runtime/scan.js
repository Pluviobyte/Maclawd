...
const CACHE_VERSION = 23; // Droid uncached input and model catalog (Vibe b4a3874).
...
function packRecords(records) {
  ...
  for (const r of records) {
    ...
    rows.push([
      ...
      r.messageId ?? 0, r.requestId ?? 0, r.uuid ?? 0, r.sidechain ? 1 : 0, r.usageSource ?? null, r.project ?? null, r.billing ?? null,
    ]);
  }
